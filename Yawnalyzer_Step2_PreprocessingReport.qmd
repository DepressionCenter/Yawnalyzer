...
```{python}
if has_hr:
    hr_histogram_df = hr_sorted_df.sort_values("Time_Averaged_Over_in_Minutes")
    #hr_histogram_df = hr_histogram_df.tips()

    hr_box_fig =px.box(hr_histogram_df, y="Time_Averaged_Over_in_Minutes", x="ID", points="all")
